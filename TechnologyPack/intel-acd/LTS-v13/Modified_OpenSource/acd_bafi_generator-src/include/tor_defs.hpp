...
union McerrErrorSourceSpr
{
    struct
    {
        uint32_t reserved0 : 14, rmsmi_internal: 1, rmca_internal: 1, reserved1: 4,
        msmi_internal : 1, reserved2 : 2, msmi_external : 1, reserved3 : 4,
        caterr_interal : 1, reserved4 : 2, caterr_external: 1;
    };
    uint32_t value;
};
...
struct TORDataGeneric
{
    ...
    union
    {
        struct
        {
            uint32_t reserved42: 3, lcs2: 4, reserved43: 4, fsm2: 6, reserved44: 15;
        };
