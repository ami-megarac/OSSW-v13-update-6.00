...
class GenericReport
{
  ...
  protected:
            ...
            json& summaryEntry)
    {
        ...
        if (ctx.mcerrErr.value == 0 && ctx.mcerrErrSpr.value)
        {
        ...
        else
        {
            if (Cpu == "SPR")
            {
                ...
                if (ctx.mcerrErrSpr.msmi_internal)
                {
                    ss << "IntMSMI, ";
                }
                if (ctx.mcerrErrSpr.msmi_external)
                {
                    ss << "ExtMSMI, ";
                }
                if (ctx.mcerrErrSpr.caterr_interal)
                {
                    ss << "IntCATERR, ";
                }
                if (ctx.mcerrErrSpr.caterr_external)
                {
                    ss << "ExtCATERR, ";
                }
            }
